...
export default function Collection() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-x-4">
        <div className="h-[296px] bg-gradient-to-r from-gra3 to-gra4 rounded p-6 group relative">
          <div className="mt-20">
            ...
            <span className="opacity-70"> • Provisions </span>
            ...
            <span className="text-sm font-semibold">Emir Can İğrek</span>{" "}
            <span className="opacity-70"> • Poem with Fire </span>
            <span className="text-sm font-semibold">Emir Can İğrek</span>{" "}
            <span className="opacity-70"> • Provisions </span>
            <span className="text-sm font-semibold">Emir Can İğrek</span>{" "}
            <span className="opacity-70"> • Provisions</span>
          ...
          <div>
            <h3 className="text-3xl font-bold mt-6">Favorite Songs</h3>
            <p>204 Favorite Songs</p>
          </div>
      ...
      <div>
      <p align="center"><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><b>© 2024 React-Spotify Clone. All Rights Reserved | Design By Amit Roy.<br /><br /></b></p>
      </div>
    </div>
  );
}
