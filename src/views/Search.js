...
export default function Search() {
  return (
    <div>
      <h3 className='text-2xl text-white font-bold tracking-tight mb-4'>Your most listened genres</h3>
      ...
      <div>
      <p align="center"><br /><b>© 2024 React-Spotify Clone. All Rights Reserved | Design By Amit Roy.<br /><br /></b></p>
      </div>
    </div>
  )
}